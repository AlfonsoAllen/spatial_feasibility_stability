...
data_D_aux2 <- readr::read_csv("Results/FD_2sp_toy_DOM_HALF_100xD.csv") %>% 
...
data_D_aux3 <- readr::read_csv("Results/FD_2sp_toy_DOM_HALF_10xD.csv") %>% 
  mutate(Feasible = number_feasible_sol>0,
         Feasible_stable = number_feasible_stable_sol>0,
         r1B=round(r1B,3),
         r2B=round(r2B,3)) %>%
...
data_D_aux4 <- readr::read_csv("Results/FD_2sp_toy_DOM_HALF_1xD.csv") %>% 
  mutate(Feasible = number_feasible_sol>0,
         Feasible_stable = number_feasible_stable_sol>0,
         r1B=round(r1B,3),
         r2B=round(r2B,3)) %>%
...
result_metrics_D_aux2 <- expand.grid(r1B = r1B, 
                              r2B = r1B, 
                              D = D_aux2)
result_metrics_D_aux2$shape_mn <- NA
result_metrics_D_aux2$relmutinf <- NA
result_metrics_D_aux2$marg_ent <- NA
result_metrics_D_aux2$perc_feasible <- NA
result_metrics_D_aux2$perc_feasible_stable <- NA

result_metrics_D_aux3 <- result_metrics_D_aux2
result_metrics_D_aux3$D <- D_aux3

result_metrics_D_aux4 <- result_metrics_D_aux2
result_metrics_D_aux4$D <- D_aux4

for (i in 1:nrow(result_metrics_D_aux2)) {
  
  r1B_aux <- round(result_metrics_D_aux2$r1B[i],3)
  r2B_aux <- round(result_metrics_D_aux2$r2B[i],3)
...
# write.csv(result_metrics_D_aux2,"Results/result_metrics_PERFECT_D_aux2.csv")
# write.csv(result_metrics_D_aux3,"Results/result_metrics_PERFECT_D_aux3.csv")
# write.csv(result_metrics_D_aux4,"Results/result_metrics_PERFECT_D_aux4.csv")

# result_metrics_D_aux1 <- readr::read_csv("Results/result_metrics_D_aux1.csv")
result_metrics_D_aux2 <- readr::read_csv("Results/result_metrics_PERFECT_D_aux2.csv")
result_metrics_D_aux3 <- readr::read_csv("Results/result_metrics_PERFECT_D_aux3.csv")
result_metrics_D_aux4 <- readr::read_csv("Results/result_metrics_PERFECT_D_aux4.csv")
...
plot_grid(plot_percen_D_aux2,
          plot_percen_D_aux3,
          plot_percen_D_aux4, align = "v", axis = "tb")

plot_grid(plot_relmutinf_D_aux2,
