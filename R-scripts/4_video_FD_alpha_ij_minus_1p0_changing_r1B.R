...
data_D_aux2 <- readr::read_csv("Results/FD_2sp_toy_DOM_ZERO_V4_100xD.csv") %>% 
...
output_video <- "Figures/Videos/alpha_ij_minus_1p0_D_0p01.mp4"
...
data_D_aux3 <- readr::read_csv("Results/FD_2sp_toy_DOM_ZERO_V4_10xD.csv") %>% 
  mutate(Feasible = number_feasible_sol>0,
         Feasible_stable = number_feasible_stable_sol>0,
         r1B=round(r1B,3)) %>%
...
# Definir la ruta y nombre del archivo de video
output_video <- "Figures/Videos/alpha_ij_minus_1p0_D_0p1.mp4"
...
data_D_aux4 <- readr::read_csv("Results/FD_2sp_toy_DOM_ZERO_V4_1xD.csv") %>% 
  mutate(Feasible = number_feasible_sol>0,
         Feasible_stable = number_feasible_stable_sol>0,
         r1B=round(r1B,3)) %>%
...
# Definir la ruta y nombre del archivo de video
output_video <- "Figures/Videos/alpha_ij_minus_1p0_D_1p0.mp4"
