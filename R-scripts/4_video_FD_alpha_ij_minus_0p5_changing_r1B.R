...
output_video <- "Figures/Videos/alpha_ij_minus_0p5_D_0p01.mp4"
...
# Definir la ruta y nombre del archivo de video
output_video <- "Figures/Videos/alpha_ij_minus_0p5_D_0p1.mp4"
...
# Definir la ruta y nombre del archivo de video
output_video <- "Figures/Videos/alpha_ij_minus_0p5_D_1p0.mp4"
