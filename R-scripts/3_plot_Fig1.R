...
r1B_aux = round(0.08,3)
r2B_aux = round(0.055,3)

####################################################################
# Load data
# NEUTRAL COMPETITIVE SPECIES: alpha_ij = -1
data_D_aux2 <- readr::read_csv("Results/data_FD_example_r1B_0p08_r2B0p055_100xD.csv") %>%
  mutate(alpha_ij = 1)
data_D_aux3 <- readr::read_csv("Results/data_FD_example_r1B_0p08_r2B0p055_10xD.csv") %>%
  mutate(alpha_ij = 1)
data_D_aux4 <- readr::read_csv("Results/data_FD_example_r1B_0p08_r2B0p055_1xD.csv") %>%
  mutate(alpha_ij = 1)
...
data_D_aux2_PERFECT <- readr::read_csv("Results/data_FD_example_PERFECT_r1B_0p08_r2B0p055_100xD.csv") %>%
  mutate(alpha_ij = 0)
data_D_aux3_PERFECT <- readr::read_csv("Results/data_FD_example_PERFECT_r1B_0p08_r2B0p055_10xD.csv") %>%
  mutate(alpha_ij = 0)
data_D_aux4_PERFECT <- readr::read_csv("Results/data_FD_example_PERFECT_r1B_0p08_r2B0p055_1xD.csv") %>%
  mutate(alpha_ij = 0)
...
data_D_aux2_HALF <- readr::read_csv("Results/data_FD_example_HALF_r1B_0p08_r2B0p055_100xD.csv") %>%
  mutate(alpha_ij = 0.5)
data_D_aux3_HALF <- readr::read_csv("Results/data_FD_example_HALF_r1B_0p08_r2B0p055_10xD.csv") %>%
  mutate(alpha_ij = 0.5)
data_D_aux4_HALF <- readr::read_csv("Results/data_FD_example_HALF_r1B_0p08_r2B0p055_1xD.csv") %>%
  mutate(alpha_ij = 0.5)
